...
class MyModel(torch.nn.Module):
    def __init__(self):
        ...
        self.gru = torch.nn.GRU(14, 16, batch_first=True)
        self.fc = torch.nn.Linear(16, 1)

    def forward(self, x):
        _, h_n = self.gru(x)  # h_n has shape (1, batch_size, hidden_size)
