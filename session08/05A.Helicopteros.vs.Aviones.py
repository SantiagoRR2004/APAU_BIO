...
plt.ylim((0, 2))
plt.legend()
plt.savefig(os.path.join(currentDirectory, "05A.Helicopters.vs.planes.Loss.png"))
...
plt.xlabel("Epochs")
plt.legend()
plt.savefig(os.path.join(currentDirectory, "05A.Helicopters.vs.planes.Accuracy.png"))
