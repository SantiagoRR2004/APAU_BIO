...
modelAE = AE()
modelAE.load_state_dict(torch.load('/home/leandro/models/AutoEncoders/01.AE.pth', weights_only=True))
modelAE.eval()
...
modelVAE = VAE()
modelVAE.load_state_dict(torch.load('/home/leandro/models/AutoEncoders/04.VAE.pth', weights_only=True))
modelVAE.eval()
